...
class addTrains extends Component{
    ...
    onSubmit(e){
        ...
        axios.post('http://localhost:4000/train/add', obj)
          ...
          <div className="App Container">
            <form onSubmit={this.onSubmit}>
                <FormGroup>
                    ...
                    <Input type="text" name="name" id="name" placeholder="Train name" onChange={this.onChangeName} value={this.state.name}/>
                </FormGroup>
                <FormGroup>
